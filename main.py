...
def cerca_prezzo_unificato(nome_prodotto, barcode, cap="20121"):
    ...
    # URL originale di Everli
    target_url = f"https://www.everli.com/api/v2/search?q={query_pulita}&zipcode={cap}"
    
    # Usiamo un proxy CORS pubblico per camuffare la richiesta proveniente dal server Streamlit
    ...
    try:
        ...
        if response.status_code == 200:
            # Il proxy restituisce la risposta dentro un campo "contents" in formato stringa
        ...
        # PIANO B: Se il proxy o Everli falliscono, estraiamo un prezzo stimato basato sulle nostre categorie
...
if barcode:
    ...
    if info_prodotto["success"]:
        ...
        # Eseguiamo la ricerca del prezzo usando il proxy
