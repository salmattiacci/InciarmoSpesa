...
# Se il bot non ha ancora aggiornato il CSV, creiamo le colonne vuote per non far crashare l'app
...
# Ricerca intelligente su tutte le colonne messe in sicurezza
